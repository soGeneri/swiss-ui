...
export const RichTextToolbar: React.FC<RichTextToolbarProps> = ({ editor, onLinkClick }) => {
  ...
  return (
    <div className="flex items-center gap-1 p-1 border border-[var(--swiss-border,#000000)] bg-[var(--swiss-panel,#E5E5E0)]">
      {tools.map((tool) => (
        <Button
          key={tool.label}
          type="button"
          ...
          className={cn(
            ...
            tool.isActive && 'bg-[var(--swiss-primary,#1D4ED8)] text-white hover:bg-[var(--swiss-primary-hover,#1E40AF)] hover:text-white'
          )}
        >
